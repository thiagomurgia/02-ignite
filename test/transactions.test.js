...
(0, vitest_1.describe)('Transactions routes', () => {
    ...
    (0, vitest_1.it)('user can create a new transaction', () => __awaiter(void 0, void 0, void 0, function* () {
        const segundatransacao = yield (0, supertest_1.default)(app_1.app.server)
            .post('/transactions')
            .send({
    ...
    (0, vitest_1.it)('should be able to list all transactions', () => __awaiter(void 0, void 0, void 0, function* () {
        const createTransactionsResponse = yield (0, supertest_1.default)(app_1.app.server)
            .post('/transactions')
            .send({
            title: 'New transaction',
            amount: 5000,
...
(0, vitest_1.it)('should be able to get a specific transaction', () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const getTransactionReponse = yield (0, supertest_1.default)(app_1.app.server)
        .get(`/transactions/${transactionId}`)
        .set('Cookie', cookies)
        .expect(200);
    (0, vitest_1.expect)(getTransactionReponse.body.transactions).toEqual(vitest_1.expect.objectContaining({
        title: 'New transaction',
        amount: 5000,
    }));
}));
